...
This repo provides the code to replicate the dataset and the regression output in my paper "Government Regulation in Decentralized Finance: The Effects of the Tornado Cash Sanctions on User Behavior and Protocol Activity"
